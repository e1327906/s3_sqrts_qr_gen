...
public class SecurityConfiguration {
    ...
    // If you need to disable CORS in this service.,
    // when you call from this domain form spring cloud api gateway or other services which are already allow CORS
    // must not turn on CORS twice
    /*@Bean
    CorsConfigurationSource corsConfigurationSource()
    {
        ...
        configuration.setAllowCredentials(false); // Enable if credentials are required
